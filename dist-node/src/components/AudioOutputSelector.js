    ...
    return (<Card>
            ...
            <CardContent className="space-y-4">
                {!audioPermissionGranted ? (<div>
                        ...
                        <select id="audio-output-select" value={selectedAudioOutputId} onChange={(e) => setAudioOutputDevice(e.target.value)} className="input w-full">
                            <option value="default">Default System Output</option>
                            {audioDevices.map(device => (<option key={device.deviceId} value={device.deviceId}>
