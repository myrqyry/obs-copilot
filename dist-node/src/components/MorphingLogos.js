...
const MorphingLogos = () => {
    const morphingPathRef = useRef(null);
    ...
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width={48} height={48} style={{
            overflow: 'hidden',
            display: 'block',
            ...
            <path ref={morphingPathRef} fill="url(#logo-gradient)" d={paths.gemini} fillRule="evenodd"/>
        </svg>);
};
