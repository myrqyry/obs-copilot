...
import { catppuccinChatBubbleColorsHexMap, catppuccinMochaColors } from '../../types';
export const ChatBubblePreview = ({ userColor, modelColor, flipSides, extraDarkMode, customBackground, bubbleFillOpacity = 0.85, backgroundOpacity = 0.7, chatBackgroundBlendMode = 'normal', chatBubbleBlendMode = 'normal', }) => {
    ...
    return (<div className="flex flex-col items-stretch justify-center w-full py-2 px-1 mb-2 rounded-lg border border-border bg-background/70 relative overflow-hidden">
            {/* Background image with opacity - separate from content */}
            {customBackground && (<div className="absolute inset-0" style={{
