...
export const OBS_EVENT_LIST = [
    { name: 'CurrentProgramSceneChanged', description: 'The current program scene has changed.' },
    { name: 'CurrentPreviewSceneChanged', description: 'The current preview scene has changed (Studio Mode).' },
    ...
    { name: 'InputAudioSyncOffsetChanged', description: 'The audio sync offset of an input changed.' },
    { name: 'InputAudioTracksChanged', description: 'The audio tracks of an input changed.' },
    { name: 'InputAudioMonitorTypeChanged', description: 'The audio monitor type of an input changed.' },
    ...
    { name: 'InputPropertiesListPropertyItemsChanged', description: 'A list property in input properties changed.' },
