...
export type ObsAction = CreateInputAction | SetInputSettingsAction | SetSceneItemEnabledAction | GetInputSettingsAction | GetSceneItemListAction | SetCurrentProgramSceneAction | SetVideoSettingsAction | CreateSceneAction | RemoveInputAction | SetSceneItemTransformAction | CreateSourceFilterAction | SetInputVolumeAction | SetInputMuteAction | StartVirtualCamAction | StopVirtualCamAction | SaveScreenshotAction | StartReplayBufferAction | SaveReplayBufferAction | SetSourceFilterIndexAction | SetSourceFilterNameAction | DuplicateSourceFilterAction | TriggerStudioModeTransitionAction | SetInputAudioMonitorTypeAction | SetSceneItemBlendModeAction | RefreshBrowserSourceAction | GetLogFileListAction | GetLogFileAction | ToggleStudioModeAction | SetStudioModeEnabledAction | TriggerHotkeyByNameAction | TriggerHotkeyByKeySequenceAction | GetSourceFilterListAction | GetSourceFilterDefaultSettingsAction | GetSourceFilterSettingsAction | SetSourceFilterSettingsAction | SetSourceFilterEnabledAction | RemoveSourceFilterAction | ToggleStreamAction | ToggleRecordAction | GetInputDefaultSettingsAction | GetOutputListAction | GetOutputStatusAction | StartOutputAction | StopOutputAction | GetOutputSettingsAction | SetOutputSettingsAction | GetSceneTransitionListAction | GetCurrentSceneTransitionAction | SetCurrentSceneTransitionAction | SetSceneTransitionDurationAction | GetSceneTransitionCursorAction | GetMediaInputStatusAction | SetMediaInputCursorAction | OffsetMediaInputCursorAction | TriggerMediaInputActionAction | GetCurrentPreviewSceneAction | SetCurrentPreviewSceneAction | GetSceneItemLockedAction | SetSceneItemLockedAction | GetSceneItemIndexAction | SetSceneItemIndexAction | CreateSceneItemAction | RemoveSceneItemAction | GetStatsAction | GetVersionAction | GetHotkeyListAction | GetInputPropertiesListPropertyItemsAction | PressInputPropertiesButtonAction | GetInputAudioBalanceAction | SetInputAudioBalanceAction | GetInputAudioSyncOffsetAction | SetInputAudioSyncOffsetAction | GetInputAudioTracksAction | SetInputAudioTracksAction | DuplicateSceneAction | GetSourceScreenshotAction | SetCurrentSceneTransitionSettingsAction | OpenInputPropertiesDialogAction | OpenInputFiltersDialogAction | OpenInputInteractDialogAction | SetSceneNameAction | RemoveSceneAction | GetStreamStatusAction | StartStreamAction | StopStreamAction | GetRecordStatusAction | StartRecordAction | StopRecordAction | ToggleRecordPauseAction | GetVideoSettingsAction | GetSceneItemTransformAction | GetSourceFilterAction | GetInputVolumeAction | GetVirtualCamStatusAction | GetReplayBufferStatusAction | DuplicateSceneItemAction | StopReplayBufferAction | GetCurrentProfileAction | SetCurrentProfileAction | GetCurrentSceneCollectionAction | SetCurrentSceneCollectionAction | SetStreamInfoAction;
