...
export const EVENT_DATA_CONFIGS = {
    'StreamStateChanged': [
        {
            name: 'outputState',
            type: 'select',
            options: ['OBS_WEBSOCKET_OUTPUT_STARTING', 'OBS_WEBSOCKET_OUTPUT_STARTED', 'OBS_WEBSOCKET_OUTPUT_STOPPING', 'OBS_WEBSOCKET_OUTPUT_STOPPED'],
