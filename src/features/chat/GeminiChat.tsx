...
export const GeminiChat: React.FC<GeminiChatProps> = ({
    ...
    const extraDarkMode = useThemeStore((state) => state.extraDarkMode);
    const accentColorName = useThemeStore((state) => state.theme.accent);
    const userChatBubble = useThemeStore((state) => state.theme.userChatBubble);
    const modelChatBubble = useThemeStore((state) => state.theme.modelChatBubble);
    const customChatBackground = useThemeStore((state) => state.customChatBackground);
    const chatBackgroundType = useThemeStore((state) => state.chatBackgroundType);
