...
import { getWcagTextColor } from '@/shared/utils/contrast';
...
export const ChatBubblePreview = React.memo(
    ...
    (prevProps, nextProps) => {
        ...
        return (
            ...
            prevProps.modelColor === nextProps.modelColor &&
            prevProps.flipSides === nextProps.flipSides &&
            prevProps.extraDarkMode === nextProps.extraDarkMode &&
            prevProps.customBackground === nextProps.customBackground &&
            prevProps.bubbleFillOpacity === nextProps.bubbleFillOpacity &&
            prevProps.secondaryAccent === nextProps.secondaryAccent &&
            prevProps.chatBubbleBlendMode === nextProps.chatBubbleBlendMode
        );
    }
);
ChatBubblePreview.displayName = 'ChatBubblePreview';
